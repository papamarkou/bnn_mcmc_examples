...
OUTDIR01 <- file.path("output", "optim", "multiple_runs", "normal_prior", "var010", "linear_activation", "iters001000")
...
if (store) {
  pdf(file=file.path(OUTDIR00, "mlp_iris_optim_multiple_runs_b_ii.pdf"), width=20, height=6)
}
...
plot(
  ...
  main="Optimization solutions with linear activation",
  col=cols[1],
  cex.axis=1.8,
  cex.main=2,
  cex.lab=2,
