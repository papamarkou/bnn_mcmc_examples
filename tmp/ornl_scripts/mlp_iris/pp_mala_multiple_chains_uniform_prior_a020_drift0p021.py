...
#OUTDIR = os.path.join("output", "pp_mala", "multiple_chains", "uniform_prior", "a020", "drift0p021")
...
drift_step = 0.02
per_chain_samplers = num_powers * [['MALA', {'step': drift_step, 'truncation': [-a, a]}]]
...
for i in [0]: # range(num_chains):
    ...
    sampler = PowerPosteriorSampler(model, theta0, dataloader, per_chain_samplers, b=0.2)
