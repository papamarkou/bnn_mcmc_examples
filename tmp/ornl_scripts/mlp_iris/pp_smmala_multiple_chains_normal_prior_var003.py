...
OUTDIR = os.path.join("output", "pp_smmala", "multiple_chains", "normal_prior", "var003")
...
drift_step = 0.02
per_chain_samplers = \
    num_powers * [['SMMALA', {'step': drift_step, 'transform': lambda hessian: softabs(hessian, a=1000.)}]]
