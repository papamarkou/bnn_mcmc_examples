...
from bnn_mcmc_examples.examples.mlp.mnist.constants import diagnostic_iter_thres, num_chains
from bnn_mcmc_examples.examples.mlp.mnist.hmc.constants import sampler_output_path, sampler_output_run_paths
