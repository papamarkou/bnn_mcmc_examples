...
from bnn_mcmc_examples.examples.mlp.noisy_xor.setting1.constants import num_chains
from bnn_mcmc_examples.examples.mlp.noisy_xor.setting1.metropolis_hastings.constants import (
