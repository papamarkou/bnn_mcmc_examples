...
for i in range(num_chains):
    ...
    test_pred_df.to_csv(sampler_output_run_paths[i].joinpath('pred_prior_on_test_for_fig.csv'), index=False)
    ...
    plt.savefig(
        sampler_output_run_paths[i].joinpath('pred_prior_on_test.png'),
