...
from bnn_mcmc_examples.examples.mlp.noisy_xor.setting1.optim.constants import batch_size

# %% Load training dataloader

training_dataset, training_dataloader = load_xydataset_from_file(training_data_path, dtype=dtype, batch_size=batch_size)
