...
from bnn_mcmc_examples.examples.mlp.noisy_xor.setting2.mcmc.constants import diagnostic_iter_thres, num_chains
from bnn_mcmc_examples.examples.mlp.noisy_xor.setting2.mcmc.dataloaders import test_dataloader
