...
from bnn_mcmc_examples.examples.mlp.penguins.prior.constants import sampler_output_run_paths
...
for i in range(num_chains):
    test_pred_df = pd.read_csv(
        sampler_output_run_paths[i].joinpath('pred_prior_on_test.csv'),
        header=None,
    ...
    test_pred_df.to_csv(sampler_output_run_paths[i].joinpath('pred_prior_on_test_for_fig.csv'))
