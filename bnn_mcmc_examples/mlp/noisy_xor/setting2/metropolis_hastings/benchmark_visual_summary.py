...
from bnn_mcmc_examples.mlp.noisy_xor.setting2.constants import num_chains
from bnn_mcmc_examples.mlp.noisy_xor.setting2.metropolis_hastings.constants import (
